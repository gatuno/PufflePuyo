...
namespace Library {
	...
	enum {
		...
		IMG_PUFFLE_BLACK_IDLE_1,
		IMG_PUFFLE_BLACK_IDLE_2,
		IMG_PUFFLE_BLACK_IDLE_3,
		IMG_PUFFLE_BLACK_IDLE_4,
		IMG_PUFFLE_BLACK_PUT,
		IMG_PUFFLE_BLACK_FALL,
		
		IMG_PUFFLE_WHITE_IDLE_1,
		IMG_PUFFLE_WHITE_IDLE_2,
		IMG_PUFFLE_WHITE_IDLE_3,
		IMG_PUFFLE_WHITE_IDLE_4,
		IMG_PUFFLE_WHITE_PUT,
		IMG_PUFFLE_WHITE_FALL,
